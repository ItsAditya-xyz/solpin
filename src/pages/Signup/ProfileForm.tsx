...
function ProfileForm() {
    ...
    const fileInput = React.useRef(null as any);
              ...
              />
                        ...
                        <div className='mx-auto'>
                            <button
                                ...
                                className={` flex items-center justify-center space-x-2 font-medium text-white px-6 py-3 leading-none rounded-full buttonBG my-2 ${loading ? "cursor-not-allowed bg-opacity-50" : ""
                                    }`}>
